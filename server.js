      ...
      messages: [
        {
          role: "system",
          content:
            "너는 명리학 기반 사주 리포트를 사주전쟁 세계관으로 해석하는 프리미엄 리포트 작가다. 운명을 겁주지 말고, 원국의 구조와 지장간 아이템, 대운 스위치, 세운 타이밍을 행동 전략으로 연결한다. 현명역학원이 승인한 Review Dataset이 있으면 그 수정 기준을 최우선 스타일 가이드로 삼는다.",
        },
        {
          role: "user",
          content: prompt,
