...
모든 신규 기능을 개발하기 전에 반드시 8개의 최상위 문서와 충돌 여부를 먼저 검토한다.
...
신규 기능, 디자인 변경, AI 프롬프트 변경, DB 구조 변경, 결제/상담/리포트/커뮤니티/교육/마케팅 변경은 모두 아래 질문을 통과해야 한다.

### 3.1 Brand and Master Plan Check
...
### 3.5 Experience Bible Check

- 기능이 단순 업무가 아니라 경험으로 느껴지는가?
- 사용자의 감정 곡선이 설계되었는가?
- Weapon, Strategy Map, Quest, Academy, AI Report, AI Chat, Community의 경험 원칙과 연결되는가?
- 모션, 사운드, 마이크로 인터랙션, 보상 경험이 과하지 않지만 기억에 남는가?

### 3.6 Lore Bible Check

- 사용자가 웹사이트가 아니라 작전실에 들어왔다고 느끼게 하는가?
- Weapon, World Map, Quest, Guild, AI Strategist의 세계관 언어와 충돌하지 않는가?
...
- 절대 하지 않는 해석과 절대 하지 않는 상담을 위반하지 않는가?
- 모든 리포트와 조언이 Action으로 끝나는가?

### 3.8 Development Check
...
Conflict Decision
↓
Document Update Proposal if Needed
↓
Experience Design
↓
...
## 7. Non-Negotiable Principle

SAJU WAR는 사주 기능을 추가하는 서비스가 아니다.

SAJU WAR는 사용자가 자신의 인생을 전략적으로 이해하고, 자신의 무기를 발견하고, 다음 선택을 더 잘하도록 돕는 세계관 기반 경험 시스템이다.
